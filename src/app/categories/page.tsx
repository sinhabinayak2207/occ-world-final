...
export default function CategoriesPage() {
  ...
  useEffect(() => {
    // Get the first 6 categories from the database
    const limitedCategories = categories.slice(0, 6);
    setEnhancedCategories(limitedCategories);
    
    // Listen for category update events
    const handleCategoryUpdate = () => {
      const updatedLimitedCategories = categories.slice(0, 6);
      setEnhancedCategories(updatedLimitedCategories);
    };
